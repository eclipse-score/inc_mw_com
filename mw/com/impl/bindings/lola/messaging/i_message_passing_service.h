...
#ifndef PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_IMESSAGEPASSINGSERVICE_H
#define PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_IMESSAGEPASSINGSERVICE_H
...
class IMessagePassingService
{
  public:
    ...
    /// \param event_id
    virtual void NotifyEvent(const QualityType asil_level, const ElementFqId event_id) = 0;
    ...
    /// \param event_id full qualified event id
    /// \param target_node_id node_id, where the event provider is located.
    virtual void ReregisterEventNotification(QualityType asil_level, ElementFqId event_id, pid_t target_node_id) = 0;
    ...
    virtual void NotifyOutdatedNodeId(QualityType asil_level, pid_t outdated_node_id, pid_t target_node_id) = 0;
};
...
#endif  // PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_IMESSAGEPASSINGSERVICE_H
