...
#ifndef PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_PATH_BUILDER_H
#define PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_PATH_BUILDER_H
...
amp::optional<std::string> OptionalEmitWithPrefix(Prefix prefix, Emitter emitter) noexcept
{
...
#endif  // PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_PATH_BUILDER_H
