...
#include "platform/aas/lib/filesystem/path.h"
...
using ::bmw::memory::shared::SharedMemoryResource;
...
{
    bmw::filesystem::Path path{usage_marker_file};
...
{
    bmw::memory::shared::SharedMemoryFactory::Remove(control_path);
    bmw::memory::shared::SharedMemoryFactory::Remove(data_path);

    control_memory = bmw::memory::shared::SharedMemoryFactory::Create(
        control_file_name,
    ...
    data_memory = bmw::memory::shared::SharedMemoryFactory::Create(
        data_file_name,
