...
# See documentation in ITF version of test (platform/aas/test/mw/com/test_partial_restart_provider_max_subscribers_with_proxy.py)
def test_provider_restart_max_subscribers_with_proxy(environment):
