...
#ifndef PLATFORM_AAS_MW_COM_IMPL_PROXY_FIELD_H
#define PLATFORM_AAS_MW_COM_IMPL_PROXY_FIELD_H
...
class ProxyField final
{
  ...
  public:
    ...
    ProxyField(ProxyBase& base, const amp::string_view field_name)
    ...
    SubscriptionState GetSubscriptionState() const noexcept { return proxy_event_dispatch_.GetSubscriptionState(); }
    ...
    void Unsubscribe() noexcept { proxy_event_dispatch_.Unsubscribe(); }
    ...
    std::size_t GetFreeSampleCount() const noexcept { return proxy_event_dispatch_.GetFreeSampleCount(); }
    ...
    ResultBlank UnsetReceiveHandler() noexcept { return proxy_event_dispatch_.UnsetReceiveHandler(); }
...
#endif  // PLATFORM_AAS_MW_COM_IMPL_PROXY_FIELD_H
