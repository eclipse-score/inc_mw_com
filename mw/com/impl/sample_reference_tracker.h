...
#ifndef PLATFORM_AAS_MW_COM_IMPL_SAMPLE_PTR_REFERENCE_TRACKER_H
#define PLATFORM_AAS_MW_COM_IMPL_SAMPLE_PTR_REFERENCE_TRACKER_H
...
class TrackerGuardFactory final
{
  ...
  public:
    ...
    /// it will return amp::nullopt.
    ///
    /// \return A guard managing a single reference, amp::nullopt otherwise.
    amp::optional<SampleReferenceGuard> TakeGuard() noexcept;
...
#endif  // PLATFORM_AAS_MW_COM_IMPL_SAMPLE_PTR_REFERENCE_TRACKER_H
