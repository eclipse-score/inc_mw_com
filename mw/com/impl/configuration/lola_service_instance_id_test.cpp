...
class LolaServiceInstanceIdHashFixture
    : public ::testing::TestWithParam<std::tuple<LolaServiceInstanceId, amp::string_view>>
{
};
...
const std::vector<std::tuple<LolaServiceInstanceId, amp::string_view>> instance_id_to_hash_string_variations{
