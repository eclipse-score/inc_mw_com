...
#ifndef PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_SKELETON_EVENT_TEST_RESOURCES_H
#define PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_SKELETON_EVENT_TEST_RESOURCES_H
...
class SkeletonEventFixture : public SkeletonMockedMemoryFixture
{
  public:
    ...
    LolaServiceInstanceDeployment binding_info_{CreateLolaServiceInstanceDeployment(
        ...
        {{fake_event_name_, LolaEventInstanceDeployment{max_samples_, max_subscribers_, 1U, true}}},
        {},
        {},
        {},
...
#endif  // PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_SKELETON_EVENT_TEST_RESOURCES_H
