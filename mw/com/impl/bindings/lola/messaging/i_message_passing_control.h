...
#ifndef PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_IMESSAGEPASSINGCONTROL_H
#define PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_IMESSAGEPASSINGCONTROL_H
...
class IMessagePassingControl
{
  public:
    ...
    virtual std::shared_ptr<bmw::mw::com::message_passing::ISender> GetMessagePassingSender(
    ...
    virtual std::string CreateMessagePassingName(const QualityType asil_level, const pid_t node_id) = 0;
...
#endif  // PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_IMESSAGEPASSINGCONTROL_H
