...
TEST(RuntimeSingleProcessTest, CanRetrieveBinding)
{
    // Given a configuration at the proper location, which contains LoLa specific bindings
    ...
    // and expect that therefore the LoLa binding Runtime can be resolved
