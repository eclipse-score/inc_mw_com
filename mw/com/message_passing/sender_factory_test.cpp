...
{
  public:
    void SetUp() override { message_passing::SenderFactory::InjectSenderMock(&sender_mock_); }
    void TearDown() override { message_passing::SenderFactory::InjectSenderMock(nullptr); }
