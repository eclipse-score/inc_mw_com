...
TEST(UidPidMapping, RegisterMaxRetryFailure)
{
    ...
    bmw::containers::DynamicArray<UidPidMappingEntry> mapping_entries(kMaxNumberOfMappings);
...
TEST(DetailRegisterPidEmpty, NoNullPointerDereferenceInCaseOfEmptyMappingEntriesArray)
{
    ...
    bmw::containers::DynamicArray<UidPidMappingEntry> empty{number_of_elements};
