...
#ifndef PLATFORM_AAS_MW_COM_IMPL_PROXY_EVENT_BINDING_BASE_H
#define PLATFORM_AAS_MW_COM_IMPL_PROXY_EVENT_BINDING_BASE_H
...
class ProxyEventBindingBase
{
  public:
    ...
    virtual ResultBlank SetReceiveHandler(BindingEventReceiveHandler handler) noexcept = 0;
...
#endif  // PLATFORM_AAS_MW_COM_IMPL_PROXY_EVENT_BINDING_BASE_H
