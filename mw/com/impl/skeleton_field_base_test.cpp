...
class MyDummyField : public SkeletonFieldBase
{
  public:
    ...
    bool IsInitialValueSaved() const noexcept override { return is_initial_value_saved_; }
...
{
  public:
    ResultBlank DoDeferredUpdate() noexcept override { return MakeUnexpected(ComErrc::kCommunicationLinkError); }
};
...
TEST_F(SkeletonFieldBaseFixture, PrepareOfferPropagatesErrorFromBinding)
{
    ...
    EXPECT_CALL(*mock_event_binding_, PrepareOffer())
        .WillOnce(Return(bmw::MakeUnexpected(bmw::mw::com::impl::ComErrc::kInvalidBindingInformation)));
    ...
    EXPECT_EQ(result.error(), bmw::mw::com::impl::ComErrc::kInvalidBindingInformation);
}
