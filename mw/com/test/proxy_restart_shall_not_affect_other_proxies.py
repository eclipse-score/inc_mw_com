...
def test_proxy_restart_shall_not_affect_other_proxies(adaptive_environment_fixture):
    with proxy_restart_shall_not_affect_other_proxies(adaptive_environment_fixture):
        pass
