...
#ifndef PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_EVENT_DATA_CONTROL_TEST_RESOURCES_H
#define PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_EVENT_DATA_CONTROL_TEST_RESOURCES_H
...
class EventDataControlCompositeAttorney
{
  public:
    ...
    std::pair<EventSlotStatus, amp::optional<EventSlotStatus>> GetSlotStatus(
...
class EventDataControlAttorney
{
  public:
    ...
    ///        next call to AllocateNextSlot() will return the given expected_result
    /// \param expected_result to be expected result for AllocateNextSlot()
    void PrepareAllocateNextSlot(const amp::optional<EventDataControl::SlotIndexType> expected_result) noexcept;
...
#endif  // PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_EVENT_DATA_CONTROL_TEST_RESOURCES_H
