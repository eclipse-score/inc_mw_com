...
{
    RecordProperty("Verifies", "8, 3, , SSR-6225206");
    RecordProperty("Description",
                   "Checks that allocation algo aborts correctly (req. SSR-6225206) and an is returned on "
                   "allocation error (req. 8, 3) and that the number of slots is a "
                   "configurable param handed over in ctor (req. )");
...
{
    RecordProperty("Verifies", ", 4, 0, 8, 8");
    RecordProperty("Description",
...
{
    RecordProperty("Verifies", "7, 9, 1, 8");
    RecordProperty("Description",
