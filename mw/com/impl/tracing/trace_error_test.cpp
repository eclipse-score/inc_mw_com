...
{
  protected:
    void testErrorMessage(TraceErrorCode errorCode, amp::string_view expectedErrorOutput)
    {
        const auto errorCodeTest =
            trace_config_error_domain_dummy.MessageFor(static_cast<bmw::result::ErrorCode>(errorCode));
