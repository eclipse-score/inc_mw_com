...
#ifndef PLATFORM_AAS_MW_COM_IMPL_TEST_BINDING_FACTORY_RESOURCES_H
#define PLATFORM_AAS_MW_COM_IMPL_TEST_BINDING_FACTORY_RESOURCES_H
...
#include "platform/aas/mw/com/impl/plumbing/proxy_event_binding_factory_mock.h"
#include "platform/aas/mw/com/impl/plumbing/proxy_field_binding_factory.h"
#include "platform/aas/mw/com/impl/plumbing/proxy_field_binding_factory_mock.h"
#include "platform/aas/mw/com/impl/plumbing/skeleton_binding_factory.h"
#include "platform/aas/mw/com/impl/plumbing/skeleton_binding_factory_mock.h"
#include "platform/aas/mw/com/impl/plumbing/skeleton_event_binding_factory.h"
#include "platform/aas/mw/com/impl/plumbing/skeleton_event_binding_factory_mock.h"
#include "platform/aas/mw/com/impl/plumbing/skeleton_field_binding_factory.h"
#include "platform/aas/mw/com/impl/plumbing/skeleton_field_binding_factory_mock.h"
...
{
  public:
    ProxyBindingFactoryMockGuard() noexcept { ProxyBindingFactory::InjectMockBinding(&factory_mock_); }
    ~ProxyBindingFactoryMockGuard() noexcept { ProxyBindingFactory::InjectMockBinding(nullptr); }
...
class ProxyEventBindingFactoryMockGuard
{
  public:
    ...
    ~ProxyEventBindingFactoryMockGuard() noexcept { ProxyEventBindingFactory<SampleType>::InjectMockBinding(nullptr); }
...
class ProxyFieldBindingFactoryMockGuard
{
  public:
    ...
    ~ProxyFieldBindingFactoryMockGuard() noexcept { ProxyFieldBindingFactory<SampleType>::InjectMockBinding(nullptr); }
...
{
  public:
    SkeletonBindingFactoryMockGuard() noexcept { SkeletonBindingFactory::InjectMockBinding(&factory_mock_); }
    ~SkeletonBindingFactoryMockGuard() noexcept { SkeletonBindingFactory::InjectMockBinding(nullptr); }
...
#endif  // PLATFORM_AAS_MW_COM_IMPL_TEST_BINDING_FACTORY_RESOURCES_H
