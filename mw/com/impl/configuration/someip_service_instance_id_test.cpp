...
class SomeIpServiceInstanceIdHashFixture
    : public ::testing::TestWithParam<std::tuple<SomeIpServiceInstanceId, amp::string_view>>
{
};
...
const std::vector<std::tuple<SomeIpServiceInstanceId, amp::string_view>> instance_id_to_hash_string_variations{
