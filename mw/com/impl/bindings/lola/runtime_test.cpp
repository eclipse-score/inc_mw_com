...
class RuntimeFixture : public ::testing::Test
{
  public:
    void SetUp() override
    {
): QNX tests crashing, it happens when creating \c Runtime object by
        ...
        bmw::mw::com::message_passing::ReceiverFactory::InjectReceiverMock(&receiver_mock_);

        using ShortMessageReceivedCallback = bmw::mw::com::message_passing::IReceiver::ShortMessageReceivedCallback;
        using MediumMessageReceivedCallback = bmw::mw::com::message_passing::IReceiver::MediumMessageReceivedCallback;
        ...
        EXPECT_CALL(receiver_mock_, StartListening)
            .WillRepeatedly(::testing::Return(amp::expected_blank<bmw::os::Error>{}));

        // mock unistd creation for unit_ member
        bmw::os::MockGuard<bmw::os::UnistdMock> unistd_mock{};
    ...
    void TearDown() override
    {
        ...
        bmw::mw::com::message_passing::ReceiverFactory::InjectReceiverMock(nullptr);  // unmock receiver
    }
...
TEST_F(RuntimeFixture, EnsureBindingTypeIsLoLa)
{
    ...
    EXPECT_EQ(unit_->GetBindingType(), bmw::mw::com::impl::BindingType::kLoLa);
}
...
{
    amp::ignore = unit_->GetLolaMessaging();
}
