...
TEST(EventSubscriptionControl, Create)
{
    ...
    detail_event_subscription_control::EventSubscriptionControlImpl<bmw::memory::shared::AtomicIndirectorMock> unit2{
        20, 3, true};
}
...
TEST(EventSubscriptionControl, CompareExchangeBehaviour_Subscribe)
{
    ...
    detail_event_subscription_control::EventSubscriptionControlImpl<bmw::memory::shared::AtomicIndirectorMock> unit{
        20, 3, true};
...
TEST(EventSubscriptionControl, CompareExchangeBehaviour_Unsubscribe_RetryLimit)
{
    ...
    auto unsubscribe_hits_retry_limit = []() -> void {
        ...
        EventSubscriptionControlAttorney<
            detail_event_subscription_control::EventSubscriptionControlImpl<bmw::memory::shared::AtomicIndirectorMock>>
            attorney{unit};
