...
#ifndef PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_TEST_TRANSACTION_LOG_TEST_RESOURCES_H
#define PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_TEST_TRANSACTION_LOG_TEST_RESOURCES_H
...
class TransactionLogSetAttorney
{
  public:
    ...
    const amp::optional<std::reference_wrapper<TransactionLog>> GetSkeletonTransactionLog() noexcept
    {
...
#endif  // PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_TEST_TRANSACTION_LOG_TEST_RESOURCES_H
