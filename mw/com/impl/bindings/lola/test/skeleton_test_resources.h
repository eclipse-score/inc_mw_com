...
#ifndef PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_SKELETON_TEST_RESOURCES_H
#define PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_SKELETON_TEST_RESOURCES_H
...
#include "platform/aas/mw/com/impl/bindings/lola/partial_restart_path_builder_mock.h"
...
LolaServiceInstanceDeployment CreateLolaServiceInstanceDeployment(
    ...
    amp::optional<std::size_t> size = amp::nullopt);
...
static const ServiceInstanceDeployment kValidInstanceDeploymentWithEvent{
    ...
    CreateLolaServiceInstanceDeployment(
        ...
        {{test::kFooEventName, LolaEventInstanceDeployment{test::kMaxSlots, 10U, 1U, true}}},
        {},
        {},
        {},
...
static const ServiceInstanceDeployment kValidInstanceDeploymentWithField{
    ...
    CreateLolaServiceInstanceDeployment(
        kDefaultLolaInstanceId,
        {},
        {{test::kFooEventName, LolaFieldInstanceDeployment{test::kMaxSlots, 10U, 1U, true}}},
        {},
        {},
        kConfiguredDeploymentShmSize),
    QualityType::kASIL_QM,
...
class SkeletonAttorney
{
  public:
    ...
    void InitializeSharedMemoryForControl(const QualityType asil_level,
                                          std::shared_ptr<bmw::memory::shared::ManagedMemoryResource> memory) noexcept
    {
        return skeleton_.InitializeSharedMemoryForControl(asil_level, memory);
    }

    void InitializeSharedMemoryForData(std::shared_ptr<bmw::memory::shared::ManagedMemoryResource> memory) noexcept
    {
  ...
  public:
        ...
        ServiceDataStorage& service_data_storage) noexcept
    {
        ...
        auto* const typed_event_data_storage =
            static_cast<EventDataStorage<SampleType>*>(event_data_storage_offset_ptr.get());
    ...
    std::shared_ptr<::testing::StrictMock<memory::shared::SharedMemoryResourceHeapAllocatorMock>>
        control_qm_shared_memory_resource_mock_{
            std::make_shared<::testing::StrictMock<memory::shared::SharedMemoryResourceHeapAllocatorMock>>(
...
#endif  // PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_SKELETON_TEST_RESOURCES_H
