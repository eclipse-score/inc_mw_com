...
{
  protected:
    void testErrorMessage(ComErrc errorCode, amp::string_view expectedErrorOutput)
    {
        const auto errorCodeTest = ComErrorDomainDummy.MessageFor(static_cast<bmw::result::ErrorCode>(errorCode));
