...
#ifndef PLATFORM_AAS_MW_COM_IMPL_TRAITS_H
#define PLATFORM_AAS_MW_COM_IMPL_TRAITS_H
...
// NOLINTNEXTLINE(bmw-struct-usage-compliance): Tolerated.
class SkeletonWrapperClass : public Interface<Trait>
{
  public:
        ...
        MethodCallProcessingMode mode = MethodCallProcessingMode::kEvent) noexcept
    {
        ...
        {
            ::bmw::mw::log::LogError("lola") << "Could not create SkeletonWrapperClass as Skeleton binding or service "
...
#endif  // PLATFORM_AAS_MW_COM_IMPL_TRAITS_H
