...
#ifndef PLATFORM_AAS_MW_COM_IMPL_CONFIGURATION_SOMEIP_SERVICE_INSTANCE_ID_H
#define PLATFORM_AAS_MW_COM_IMPL_CONFIGURATION_SOMEIP_SERVICE_INSTANCE_ID_H
...
/// \brief Struct that wraps the type of a SomeIp instance ID.
///
...
class SomeIpServiceInstanceId
{
  public:
    ...
    explicit SomeIpServiceInstanceId(const bmw::json::Object& json_object) noexcept;
...
#endif  // PLATFORM_AAS_MW_COM_IMPL_CONFIGURATION_SOMEIP_SERVICE_INSTANCE_ID_H
