...
class ProxyBaseFixture : public ::testing::Test
{
  public:
    ...
    BindingEventReceiveHandler CreateMockBindingEventReceiveHandler(MockFunction<void()>& mock_function)
    {
        return BindingEventReceiveHandler(event_receive_handler_scope_, mock_function.AsStdFunction());
    }
...
TEST_F(ProxyBaseStartFindServiceInstanceSpecifierFixture, StartFindServiceWillDispatchToBinding)
{
    ...
    RecordProperty("Description",
                   ...
                   "regular Proxy (2) and a GenericProxy (5).");
    RecordProperty("TestingTechnique", "Requirements-based test");
    RecordProperty("DerivationTechnique", "Analysis of requirements");
    ...
    amp::ignore = ProxyBase::StartFindService([](auto, auto) noexcept {}, kInstanceSpecifier);
}
       ...
       StartFindServiceWillReturnFindServiceHandleFromBindingOnSuccess)
{
    ...
    RecordProperty("Description",
                   ...
                   "success for a regular Proxy (2) and a GenericProxy (5).");
    RecordProperty("TestingTechnique", "Requirements-based test");
    RecordProperty("DerivationTechnique", "Analysis of requirements");
...
TEST_F(ProxyBaseStartFindServiceInstanceSpecifierFixture, StartFindServiceWillReturnPropagateErrorFromBinding)
{
    ...
    RecordProperty(
        ...
        "call to the binding returns an error for a regular Proxy (2) and a GenericProxy "
        "(5).");
    RecordProperty("TestingTechnique", "Requirements-based test");
    RecordProperty("DerivationTechnique", "Analysis of requirements");
...
TEST_F(ProxyBaseStartFindServiceInstanceIdentifierFixture, StartFindServiceWillDispatchToBinding)
{
    ...
    // When calling StartFindService
    amp::ignore = ProxyBase::StartFindService([](auto, auto) noexcept {}, kInstanceIdWithLolaBinding);
}
       ...
       StartFindServiceWillReturnFindServiceHandleFromBindingOnSuccess)
{
    ...
    RecordProperty("Description",
                   ...
                   "success for a regular Proxy (3) and a GenericProxy (4).");
    RecordProperty("TestingTechnique", "Requirements-based test");
    RecordProperty("DerivationTechnique", "Analysis of requirements");
...
TEST_F(ProxyBaseStartFindServiceInstanceIdentifierFixture, StartFindServiceWillReturnPropagateErrorFromBinding)
{
    ...
    RecordProperty("Description",
                   ...
                   "call to the binding returns an error for a regular Proxy (3) and a GenericProxy "
                   "(4).");
    RecordProperty("TestingTechnique", "Requirements-based test");
    RecordProperty("DerivationTechnique", "Analysis of requirements");
...
{
    RecordProperty("ParentRequirement", "4, 6");
    RecordProperty("Description",
                   "StopFindService will dispatch to the underlying Proxy binding for a "
                   "regular Proxy (4) and a GenericProxy (6).");
    RecordProperty("TestingTechnique", "Requirements-based test");
    RecordProperty("DerivationTechnique", "Analysis of requirements");
    ...
    // When calling StartFindService
    amp::ignore = ProxyBase::StopFindService(handle);
}
...
TEST_F(ProxyBaseStopFindServiceFixture, StopFindServiceWillReturnValidResultOnSuccess)
{
    ...
    RecordProperty("Description",
                   ...
                   "success for a regular Proxy (4) and a GenericProxy (6).");
    RecordProperty("TestingTechnique", "Requirements-based test");
    RecordProperty("DerivationTechnique", "Analysis of requirements");
...
TEST_F(ProxyBaseStopFindServiceFixture, StopFindServiceWillReturnPropagateErrorFromBinding)
{
    ...
    RecordProperty("Description",
                   ...
                   "call to the binding returns an error for a regular Proxy (4) and a GenericProxy "
                   "(6).");
    RecordProperty("TestingTechnique", "Requirements-based test");
    RecordProperty("DerivationTechnique", "Analysis of requirements");
...
/// \todo Enable test when support for multiple bindings is added ()
