...
#ifndef PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_MESSAGE_ELEMENT_FQ_ID_H
#define PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_MESSAGE_ELEMENT_FQ_ID_H
...
class ElementFqIdMessage
{
  ...
  public:
    ...
    message_passing::ShortMessage SerializeToShortMessage() const
    {
    ...
    /// \return ElementFqId
    ElementFqId GetElementFqId() const noexcept { return element_fq_id_; }

    /// \brief Provide an access to the private member sender node id.
    /// \return pid_t
    pid_t GetSenderNodeId() const noexcept { return sender_node_id_; }
...
#endif  // PLATFORM_AAS_MW_COM_IMPL_BINDINGS_LOLA_MESSAGE_ELEMENT_FQ_ID_H
